...
10. **Live sources.** Implemented for Hugging Face, GitHub, official feeds and arXiv; see [ADR-0008](./adr/0008-live-ingestion.md).
11. **Deployment target.** Managed Postgres, S3-compatible object store implementation, and a worker host. The read-only public preview
